...
@testset CustomTestSet "Util functions" begin
  @testset CustomTestSet "err_must_be_overriden throws an error" begin
    @test_throws ErrorException err_must_be_overriden()
  end

  @testset CustomTestSet "weighted_median works" begin
    weights = [1, 1, 1, 1, 1]
    values = [1, 2, 3, 4, 5]
  ...
  @testset CustomTestSet "holdout returns proportional partitions" begin
    n = 10
    right_prop = 0.3
